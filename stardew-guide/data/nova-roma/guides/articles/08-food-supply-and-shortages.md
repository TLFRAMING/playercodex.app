---
slug: "food-supply-and-shortages"
title: "Nova Roma Food Supply Guide: Prevent Shortages Before Growth Turns Fragile"
category: "resources"
...
# Nova Roma Food Supply Guide: Prevent Shortages Before Growth Turns Fragile

If food pressure is starting to make your Nova Roma city feel unstable, do not answer it by placing more buildings at random. Treat food as a city-wide support chain: input, labor, storage, transport, and population demand all have to stay readable. If the shortage is already visible across several systems, begin with the broader [resource shortage guide](/nova-roma/guides/early-resource-shortage-guide).
...
This is where population planning matters. If every new residential step creates another food problem, read the [population stability guide](/nova-roma/guides/population-needs-and-stability) before adding more housing.

## Read Food As A Chain

Use the same chain order you would use for other resource pressure:

1. Is the input source active and close enough to the city shape?
2. Are enough workers available to keep the chain moving?
3. Is storage helping distribution or forcing long trips?
4. Did the consumer side grow recently?
5. Is another system, such as water or infrastructure, slowing the whole district?
...
1. Pause new demand first.
2. Check whether the source, labor, or storage is the real bottleneck.
3. Restore the smallest working chain instead of building several new pieces.
4. Move attention back to population only after the food pattern is readable again.
